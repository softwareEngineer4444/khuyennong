...
<ul class="nav nav-tabs nav-stacked">
    <li><a href="index.php?c=test&m=list">Giới thiệu</a></li>
    <li class="dropdown">
    ...
    <li><a href="index.php?c=test&m=feedback">Hỏi đáp</a></li>
...
<ul class="nav nav-tabs nav-stacked">
    ...
    <li><a href="index.php?c=test&m=logout">Logout</a></li>
    <?php else: ?>
    <li><a href="index.php?c=test&m=login">Login</a></li>
    <li><a href="index.php?c=test&m=register">Register</a></li>
    <?php endif; ?>
</ul>
